...
void AutoLogin::insert(std::string key)
{
...
void AutoLogin::findPrefixWords(std::string keyword, std::string* res)
{
...
void AutoLogin::findPrefixWords(AutoLoginNode* current, std::string prefix,
                                std::string suffix, std::string* res)
{
